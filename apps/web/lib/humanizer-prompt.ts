// Humanizer prompt — verbatim embed of blader/humanizer SKILL.md v2.5.1 body.
//
// Source: https://github.com/blader/humanizer
// License: MIT © 2025 Siqi Chen — preserved in apps/web/lib/humanizer-prompt.LICENSE
//
// Only the YAML frontmatter has been stripped. Backticks and ${...} sequences are
// escaped so the markdown survives a TS template literal. Everything else is the
// original skill content, including the "Process" and "Output Format" sections —
// the OUTPUT_OVERRIDE in humanizer.ts intentionally supersedes them at runtime.

export const HUMANIZER_BODY = `
